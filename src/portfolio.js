...
const greeting = {
  username: "Jaydev Zala",
  title: "Hi all, I'm Jaydev",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web applications with JavaScript / Reactjs / Nodejs / Flask and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/drive/folders/10BJOLlTiNGj734npy0zOgSFkB_wNJK72", // Set to empty to hide the button
...
const socialMediaLinks = {
  github: "https://github.com/Jay8401",
  linkedin: "https://www.linkedin.com/in/jaydev-zala-443a85255/",
  gmail: "mailto:jaydevzala27@gmail.com",
  medium: "https://medium.com/@jaydevzala27",
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Develop highly interactive Front end and Back end for your web applications"
    ),
  ...
  achievementsCards: [
    {
      ...
      subtitle: "Solved 450+ problems and honured by 3 bedges.",
      image: require("./assets/images/leetcodeLogo.png"),
      imageAlt: "Google Code-In Logo",
      footerLink: [
        {
          name: "Profile",
          url: "https://leetcode.com/jaydevzala27/"
        }
      ]
    },
    {
      ...
      footerLink: [
        {
          name: "Certificate",
          url: "https://drive.google.com/file/d/1-GjByJIfouVRqeEFXACGF86o5dab0HIJ/view?usp=drive_link"
        }
      ]
    },

    {
      ...
      footerLink: [
        {
          name: "Certification",
          url: "https://drive.google.com/file/d/1Is2lIl-us6Y6SdGukqpkhq0Ik2ndj0Xr/view?usp=drive_link"
        }
      ]
    }
  ],
...
const contactInfo = {
  ...
  number: "+91-8401956804",
  email_address: "jaydevzala27@gmail.com"
};
